...
public class Project {
    ...
    public static <E extends IEntity, T> MetaJpaConstructor<E,T,T> value(SingularAttribute<? super E, T> attribute) {
        checkOptionalAttributes(attribute);
        return Constructors.value(attribute);
    }

    public static <E extends IEntity, T> MetaJpaConstructor<E,T,T> value(PluralAttribute<? super E, T, ?> attribute) {
        checkOptionalAttributes(attribute);
        return Constructors.value(attribute);
    }
