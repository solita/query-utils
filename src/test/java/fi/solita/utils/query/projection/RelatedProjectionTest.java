...
public class RelatedProjectionTest extends QueryTestBase {
    ...
    public void getRelatedProjection_single() {
        ...
        Dto dto = dao.get(query.all(Employee.class), Dto_.c16(literal(VALUE._), Related.projection(Employee_.mandatoryDepartment, Project.value(Department_.mandatoryNumber))));
    ...
    public void getRelatedProjection_value_single() {
        ...
        Dto dto = dao.get(query.all(Employee.class), Project.value(Related.projection(Employee_.mandatoryDepartment, Dto_.c16(literal(VALUE._), Department_.mandatoryNumber))));
        assertEquals(42, dto.value);
    ...
    public void getRelatedProjection_set() {
        ...
        Dto dto = dao.get(query.all(Municipality.class), Dto_.c14(literal(SET_OF_IDS._), Related.projection(Municipality_.employees, Project.id())));
    ...
    public void getRelatedProjection_value_set() {
        ...
        Set<Dto> dtos = dao.get(query.all(Municipality.class), Project.value(Related.projection(Municipality_.employees, Dto_.c3(literal(ID._), Employee_.id))));
    ...
    public void getRelatedProjection_list() {
        ...
        Dto dto = dao.get(query.all(Department.class), Dto_.c6(literal(LIST_OF_IDS._), Related.projection(Department_.employees, Project.id())));
    ...
    public void getRelatedProjection_value_list() {
        ...
        List<Dto> dtos = dao.get(query.all(Department.class), Project.value(Related.projection(Department_.employees, Dto_.c3(literal(ID._), Employee_.id))));
