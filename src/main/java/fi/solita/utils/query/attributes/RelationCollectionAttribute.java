...
class RelationCollectionAttribute<E, R> extends PluralAttributeProxy<E, Collection<R>, R> implements CollectionAttribute<E,R>, AdditionalQueryPerformingAttribute {
